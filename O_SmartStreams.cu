...
int main()
{
	...
	for(int i = 0; i < ENTIRE_DATA_SET; i += DATA_CHUNKS*2)
	{
		...
		// Set up a handfull of operations on the first stream
		// Stream 0 handles chunk i
		...
		// Set up a handfull of operations on the second stream
		// Stream 1 handles chunk i + DATA_CHUNKS
